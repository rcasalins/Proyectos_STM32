...
#define BTIMER_SPEED_10us_custom	1000
...
void CaptureTimer2_Callback(void);
void CaptureTimer3_Callback(void);
void CaptureTimer4_Callback(void);
void CaptureTimer5_Callback(void);
