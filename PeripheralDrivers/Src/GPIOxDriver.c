 ...
 * para que sea lo mas generico posible, de forma que independientemente del puerto
 * GPIO y el PIN seleccionados, el programa se ejecute y configure todo correctamente.
 */
